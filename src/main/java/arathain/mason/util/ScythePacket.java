...
public class ScythePacket {
    public static final Identifier ID = new Identifier(MasonDecor.MODID, "scythe");
    ...
    public static void handle(MinecraftServer server, ServerPlayerEntity player, ServerPlayNetworkHandler network, PacketByteBuf buf, PacketSender sender) {
        ...
        server.execute(() -> {
            if(player.getStackInHand(Hand.MAIN_HAND).getItem().equals(MasonObjects.SCYTHE)) {
